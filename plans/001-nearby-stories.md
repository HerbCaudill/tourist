...
- Does the existing Google Maps integration have the enabled APIs and coverage needed for fallback geocoding, nearby discovery, and defensible story locations, and what display/retention constraints apply to the map and cache?
