...
export function App(
  ...
  return (
    <main className="mx-auto flex h-dvh max-w-md flex-col bg-[#eeeeec] pt-[calc(env(safe-area-inset-top)+24px)] font-mono text-[12.5px] leading-tight text-neutral-900">
      {!online && (
